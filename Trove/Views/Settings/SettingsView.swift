...
struct SettingsView: View {
    ...
    private var appearanceSection: some View {
        // 004 (T009): the sheet hosting this view adopts the resolved colour
        // scheme via `.preferredColorScheme` in each list/dashboard host, so a
        // live Light/Dark switch re-colours the picker's chrome without a stale
        // UIKit trait. That superseded T008's `UISegmentedControl.appearance()`
        // bridge; this view imports no UIKit and installs nothing.
