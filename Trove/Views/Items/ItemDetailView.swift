...
/// mock. Shows a placeholder when the item has no photos — most won't at
/// first, since photos are optional at creation.
private struct PhotoCarousel: View {
    ...
    private var hero: some View {
        ZStack(alignment: .bottomLeading) {
            ...
            Text(photos.isEmpty ? "No photos" : "Item photo \(safeIndex + 1) / \(photos.count)")
